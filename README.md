...
**Caution!** You *must* be very careful when using this setting. You are effectively reducing the cooling capabilities of the switch and this could result in overheating and permanent damage. If you have a PoE switch but you do not have any PoE devices, then it may be possible to reduce the fan speed safely, but it is not guaranteed.
